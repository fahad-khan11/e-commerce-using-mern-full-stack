...
const NewArrivals = () => {
  ...
  <section className='py-16 px-4 lg:px-0'>
    <div className='container mx-auto text-center mb-10 relative top-0 '>
    ...
    onMouseLeave={handleMouseUpOrLeave}
     className={`container flex gap-4 mx-auto overflow-x-scroll relative scrollbar-hide ${isDragging ? "cursor-grabbing": "cursor-grab"}`}>
        {
